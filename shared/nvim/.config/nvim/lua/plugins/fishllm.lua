return {
  {
    ...
    config = function()
      ...
      vim.keymap.set({ 'n', 'v' }, '<leader>y', fishllm.accept_suggestions, { desc = "Accept llm suggestions" })
      vim.keymap.set({ 'n', 'v' }, '<leader>am', fishllm.add_buf_to_marks, { desc = "Add buffer to marks" })
      vim.keymap.set({ 'n', 'v' }, '<leader>vm', fishllm.view_current_marks, { desc = "View session marks" })
      vim.keymap.set({ 'n', 'v' }, '<leader>aa', function() fishllm.load_mark(1) end, { desc = "Jump to first mark" })
      vim.keymap.set({ 'n', 'v' }, '<leader>ss', function() fishllm.load_mark(2) end, { desc = "Jump to second mark" })
      vim.keymap.set({ 'n', 'v' }, '<leader>dd', function() fishllm.load_mark(3) end, { desc = "Jump to third mark" })
      vim.keymap.set({ 'n', 'v' }, '<leader>ff', function() fishllm.load_mark(4) end, { desc = "Jump to fourth mark" })
