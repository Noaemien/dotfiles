return {
  ...
  {
    'yacineMTB/dingllm.nvim', -- dir = '~/.dotfiles/nvim/.config/nvim/lua/plugins/yacineMTB/dingllm.nvim', -- 'yacineMTB/dingllm.nvim',--     -- dev = true,
    dependencies = { 'nvim-lua/plenary.nvim' },
    debug = true,
    config = function()
      local system_prompt =
      'You are an inline code completion ai. You should replace the code that you are sent, only following the comments. Do not talk at all. Only output valid code. Do not provide any backticks that surround the code. Never ever output backticks like this ```. Any comment that is asking you for something should be removed after you satisfy them. Other comments should left alone. Do not output backticks. Absolutely no backticks.'
